...
The `r2` command is part of the [LightNet CLI](/cli/overview).
...
This command requires an R2 connection configured through rclone. See [Rclone setup](/cli/overview/#rclone-setup) for details.
