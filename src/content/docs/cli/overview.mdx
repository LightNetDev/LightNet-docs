...
- [`check-files`](/cli/check-files/): find broken file links and unused files.
- [`check-links`](/cli/check-links/): check Media Item URLs.
- [`check-translations`](/cli/check-translations/): find missing translation strings.
- [`r2`](/cli/r2/): manage files in a Cloudflare R2 bucket.
...
`rclone` to use [R2 commands](/cli/r2/) and [R2 file checks](/cli/check-files/#use-the---r2-option).
