...
The `check-files` command is part of the [LightNet CLI](/cli/overview).
...
R2 content-file checks require an R2 connection configured through rclone. See [Rclone setup](/cli/overview/#rclone-setup) for details.
