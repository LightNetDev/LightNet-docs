...
The `check-links` command is part of the [LightNet CLI](/cli/overview).
...
Checking links for files managed by the LightNet site overlaps with what [`check-files`](/cli/check-files/) does, but the commands answer different questions.
