...
- Files served from your server like `"/files/sermon-1.pdf"`, LightNet supports all file types like pdf, mp3, mp4, etc.
...
If it is `"https://www.youtube.com/watch?v=1234"` the content label is `youtube.com`. You also can assign a translation key to the label.
...
Use Markdown syntax for formatting the text. The first 350 characters are included in the search.
