...
LightNet uses the `commonId` to find translations of a media item. If your media item is available in multiple languages, 
...
If it is `"https://www.youtube.com/watch?v=1234"` the content label is `youtube.com`. When provided, use a locale map keyed by your configured site languages.
