...
<Aside type="note">
The dateCreated is when the media item was added to your LightNet site not when it was originally published.
</Aside>
...
An array containing the Author names of the media item.
