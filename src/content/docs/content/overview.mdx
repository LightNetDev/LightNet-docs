...
Alternatively you can use a Administration User Interface to edit the content files. This is also useful if you have non-technical users that want to edit the content. Learn more about the [Administration UI](/content/administration-ui).
