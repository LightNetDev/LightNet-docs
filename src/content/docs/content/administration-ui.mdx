...
<Steps>
1. Make sure your LightNet Library is hosted on GitLab. If this is not the case, check the [guide on hosting](/ship/hosting) on how to setup a GitLab repository
   for your project.
...
<Aside>
Even when you have configured a GitLab backend, your local development server will always connect to a local `decap-server`.
</Aside>
