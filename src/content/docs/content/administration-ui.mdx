...
description: Learn how to add an Administration UI to your site.
---
...
users. That's why LightNet provides an Administration UI to manage your content with a graphical user interface.
...
<Steps>
1. **Add the Integration**: Add the LightNet Decap CMS integration using Astro's add command. From your project folder execute:
    ```bash
...
<Aside type="caution">
We recommend setting the `path` option of the decap admin integration, to hide it from attackers.
