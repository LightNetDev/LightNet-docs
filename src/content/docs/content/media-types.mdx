...
The custom layout shows a details page with your own layout. You can define your own layout with an Astro component. An example of a custom layout configuration is:
...
LightNet wraps your component inside a `<Page>` layout.
