...
It has to be in the format `lucide--[icon-name]`. With `[icon-name]` being the name of an icon from
...
The video layout supports embedding YouTube URLs, Vimeo URLs and links to mp4 files, other links will show a fallback to open the video link in a new browser tab.
...
The audio layout supports embedding links to mp3 files, other links will show a fallback to open the audio link in a new browser tab.
