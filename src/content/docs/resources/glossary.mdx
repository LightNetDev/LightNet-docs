...
While Author works well for written works, such as a book or article, it is also used for all other Media Types.
It is recognized that it works less well for musical compositions ("Composer"), art ("Artist"), photographs ("Photographer") and so on.
