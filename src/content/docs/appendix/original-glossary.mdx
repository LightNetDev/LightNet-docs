...
## About page
A top-level page in LightNet optionally created by a Site Administrator that contains important information about the site or Ministry. The Site Administrator has full discretion over the name of the page and information therein. Common topics include:
...
## Home page
A top-level page in LightNet created by a Site Administrator that is the main page for a Site. Its URL is used to direct people to the Site. The Site Administrator has full discretion over the name of the page and information therein.

## Language
The name for the system of human communication of a particular country or community. For example, English, Ukrainian, Dutch.

In each LightNet Site, the Site Administrator may translate the user interface into another language. See also [Site Language](#site-language).

When an Site Administrator adds Media Items, such as books or videos, to a LightNet Site, the Site Administrator indicates the language used in the Media Item. See also [Content Language](#content-language).
...
The Language Selection Menu is only visible when the Site Administrator has added more than one language to the LightNet Site.
...
## OM Ministry
An OM Ministry is an organisation within [Operation Mobilisation](https://www.om.org/) that is developing vibrant communities of Jesus followers amongst the least reached.
...
## Search page
A top-level page in LightNet created by a Site Administrator that lists all the Media Items in a Site. The Site Administrator has full discretion over the name of the page and the filters available to users.
...
## Site Title
The name given to a LightNet Site by the Site Administrator. It is visible in the Header Bar.
