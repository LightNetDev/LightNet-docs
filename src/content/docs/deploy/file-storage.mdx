...
Cloudflare Pages limits each file to 25 MB.
...
to proxy requests to your Backblaze bucket. This lets you
use a custom subdomain for your file URLs, for example `https://files.your-ministry.com/a-book-about-love.pdf`.
</Aside>
