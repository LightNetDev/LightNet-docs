...
<Steps> {/*gitlab asks a lot of nonsense in the beginning, offers lots of options (e.g. private / public group, project,...) - important to mention?*/}
1. **Create a GitLab Account**: If you don't have one, sign up at [GitLab](https://gitlab.com).
1. **Add a new group**: For easier permission control when working together with others start a (private) group.
2. **Add a New Repository**: In GitLab, create a new (private) repository for your project. {/* is repository = project???*/}
