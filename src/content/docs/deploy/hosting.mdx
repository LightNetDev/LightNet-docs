---
title: Hosting
description: Learn how to host your LightNet Library on GitLab and Cloudflare Pages.
---

import { Aside, Steps, Badge } from '@astrojs/starlight/components';

## Hosting Your LightNet Library

Your LightNet Library can be hosted on any file server of your choice. To create a folder that can be deployed, run the following command from your project's root folder:
...
<Aside type="tip">
Cloudflare will automatically create preview deployments when you are working with branches. It will put a link on your merge request.
</Aside>

### Configure a Cloudflare Domain

Cloudflare Pages will provide you with a `.pages.dev` domain for free. If you need a custom domain, you can use Cloudflare Domains to purchase a domain registration.
