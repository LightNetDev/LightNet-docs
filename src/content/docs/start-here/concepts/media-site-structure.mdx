...
{/* note for review: images could be replaced as soon as there is an other example site*/}
...
![Image of Example Ministries homepage](./images/HomepageImage.png)
...
![Image Main Menu](./images/MainMenuImage.png)
...
![Image Language Selection](./images/LanguageSelectImage.png)
...
Clicking the **magnifier icon** takes visitors to the **search page**{/* ToDo: link somewhere? */}, where they can:
...
![Image Search Page](./images/SearchPageImage.png)
...
![Image Media Item](./images/MediaItemImage.png)