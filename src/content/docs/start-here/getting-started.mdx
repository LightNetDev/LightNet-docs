...
As your first customization, let’s change the site title:
...
### Optional Next Step: Make your first Change using the Administration UI

You can easily make your first content change using the Administration UI. Follow these steps:
