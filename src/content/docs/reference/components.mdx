...
This reference gives you an overview of all available components. You import them from `@lightnet/library/components`.
...
```astro title="example.astro"
---
import { Hero, Page } from "@lightnet/library/components"
...
```astro title="example.astro"
---
import { Section } from "@lightnet/library/components"
---
...
```astro title="example.astro"
---
import { Page, Section, MediaItemList } from "@lightnet/library/components"
import { getMediaItems } from "@lightnet/library/content"
...
```astro title="example.astro"
---
import { CategoriesOverview, Page } from "@lightnet/library/components"
---
<Page>
    <CategoriesOverview />
</Page>
...
```astro title="example.astro"
---
import { Icon } from "@lightnet/library/components"
---
