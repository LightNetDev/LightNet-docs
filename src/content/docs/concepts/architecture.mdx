...
SSG is a method of pre-building a website by converting raw content (e.g., [Markdown, JSON, or YAML](/start-here/helpful-skills) files) 
into static [HTML, CSS, and JavaScript](/start-here/helpful-skills) files. 
