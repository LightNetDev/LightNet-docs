...
This chapter introduces the structure of a media library built with LightNet from a site visitor's perspective.
...
The Search Page is accessible from the header bar by clicking the **magnifier icon**. On the **Search Page**, visitors can:
