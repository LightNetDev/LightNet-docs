...
All translation keys used by LightNet are defined in the [built-in English translation file](https://github.com/LightNetDev/LightNet/blob/main/packages/lightnet/src/i18n/translations/en.yml) on GitHub. This file will always be up to date.
