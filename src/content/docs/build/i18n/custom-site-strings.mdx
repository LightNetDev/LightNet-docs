...
1. **Add to translation files**: Add a entry for your custom translation key to all translation files inside `src/translations`.
    ...
    The key will be used to referenced your custom translation in your site.
...
3. **Use inside Astro component**: Use the custom translation key in your Astro component. LightNet provides a translation function with `Astro.locals.i18n.t`. 
    ...
    ```
    The translation function will return the translation of the key `Hello World` in the current language.
