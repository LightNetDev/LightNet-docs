...
<Aside type="tip">
You can use Astro's `Astro.currentLocale` to get the current site language of the site. This can be useful if you want to query media items matching the current language.
</Aside>
