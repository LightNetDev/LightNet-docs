...
<Aside>
It is also possible to build custom details pages. Still you should be aware that the components offered therefor are still 
in an experimental stadium so there might be breaking changes in the API.
Except from that you can use them the same way as the other page components but keep in mind they are specifically built 
for details pages.
</Aside>
