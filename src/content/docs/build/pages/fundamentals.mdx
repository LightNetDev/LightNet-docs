...
use the [Astro documentation](https://docs.astro.build) for deeper insights.

## Routing

Routes on your LightNet site are determined by the files in the `src/pages` directory. 
...
For example, the English "About" page would be in `src/pages/en/about.astro`.
