...
description: >
  ...
  We provide a `GallerySection` component that you can use to display your media items. Also we offer a 
...
LightNet provides a `GallerySection` component that displays a grid of media items. Also it offers a 
`getMediaItems` function that you can use to query your media items. 
...
- `video`: Takes 1 to 4 columns. This equals to `landscape` layout. Additionally all cover images have a aspect ratio of 16:9 with a black background.
