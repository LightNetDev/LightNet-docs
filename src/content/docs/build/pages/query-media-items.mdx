...
of media items. There are three different ways how to build a selection. 

- **getEntry**: Astro function to load a single item of a Astro content collection.
- **getCollection**: Astro function to filter items of a Astro content collection.
- **getMediaItems**: LightNet function to simplify filtering media items.

Here are some examples for creating a selection of media items.
...
To display a selection of media items, there are three different ways of r