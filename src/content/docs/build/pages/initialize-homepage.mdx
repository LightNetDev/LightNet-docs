...
- Section: Used to structure the page and take care of the layout of other components you want to use
- Hero Section: a big Image, optional with a Title inside, that serves as an eye-catcher, normally at the top of a page.
- Media Item Gallery: shows a selection of Media Items in an automatically adjusted sideways gallery view.
- Categories Overview: displays a grid of all available categories leading to a search page filtered by category.
