...
When selecting a favicon, make sure it has good contrast on both light and dark backgrounds.
...
This file is served at `/favicon.ico`, a standard location recognized by all browsers. The recommended size is 32 x 32 pixels.
