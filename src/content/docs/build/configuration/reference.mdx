...
Internal links will be automatically prefixed with the current locale.
...
If you set this to `true`, the search page is initially filtered by the current site language.
